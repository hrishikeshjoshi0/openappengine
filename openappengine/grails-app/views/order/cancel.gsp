...
<title>
	Order | Cancel Order # <g:fieldValue bean="${ohOrderHeaderInstance}" field="externalId" />
</title>
</head>
<body>
	<h1>
	...
	<g:form method="post" action="cancelOrder" controller="order">
				<g:hiddenField name="id" value="${ohOrderHeaderInstance?.orderId}" />
				<fieldset class="buttons">
					<g:actionSubmit class="cancel" action="cancelOrder" value="${message(code: 'default.button.cancel.label', default: 'Cancel')}" formnovalidate="" onclick="return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');" />
				</fieldset>
	</g:form>
</body>
</html>
