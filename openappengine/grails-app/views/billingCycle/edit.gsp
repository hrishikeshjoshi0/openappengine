...
<html>
	...
	<body>
		<a href="#edit-billingCycle" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-billingCycle" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${billingCycleInstance?.version}" />
				<fieldset class="form">
