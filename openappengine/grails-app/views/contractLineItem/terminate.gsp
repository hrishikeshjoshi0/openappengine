...
<html>
	<head>
		...
		<title>
			Contract | Contract# ${contractLineItemInstance?.contract?.contractNumber } | Terminate Contract Line Item
		</title>
	</head>
	<body>
		<div id="show-contractLineItem" class="content scaffold-show" role="main">
			...
			<g:form action="terminateContractLineItem" controller="contractLineItem">
			...
			<fieldset class="buttons">
				<input type="submit" name="terminateContractLineItem" id="terminateContractLineItem" value="Terminate Line Item">
			</fieldset>
			</g:form>
		</div>
	</body>
